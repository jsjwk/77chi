	    ...
	    function excute(url){
			$.ajax({
                ...
                success : function(data) {
                  ...
                  alert("退出成功!"); ;
                  window.location.href="/tribe/home";
                }
          });
		};
				...
				<div class="tribe_info">
					...
					<div class="info_sub">
						...
						<c:if test="${isMemberTag == 0}">
							<a href="javascript:void(0)" onclick="excute('/tribe/admin/apply/${tribe.id}')"><img src="${urlStatic}/images/app/tribe_nojoin.png" width="90" height="32" alt="tribe logo" /></a>
							<!-- <a href="javascript:void(0)" onclick="">加入部落</a> -->
						</c:if>
						<a href="javascript:sendRequest(true)">邀请好友</a>
					</div>
				</div>
				<div style="position:relative; float:right"> <a href ="/tribe/topic/${tribe.id}">发布</a> </div>
				<div class="title">
