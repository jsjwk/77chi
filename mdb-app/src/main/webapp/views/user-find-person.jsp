			...
			<div class="article notice">
				<div class="noti_left">
					...
					<dl class="show_dd">
						...
						<dd class="active_dd"><a href="/usercenter/personPurpose">合租伙伴意向</a></dd>
					...
					<form id="personal_form">
						<ul>
							...
							<li class="sub_btn">
								<label></label>
								<div class="sub_div">
									<a href="javascript:void(0)" onclick="submitPersonalform()"><img src="${urlStatic}/images/app/save.png" width="80" height="32" alt="logo" /></a>
								</div>
							</li>
						</ul>
					  </form>
